...
<head>
  ...
  <title>Transaksi Saya - Pedia Shop | Top Up Game Tanpa Ribet</title>
  ...
  <meta property="og:title" content="Transaksi Saya - Pedia Shop | Top Up Game Tanpa Ribet"/>
                ...
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                    <a class="nav-link" href="https://games.pediashop.my.id"><i class="fa fa-home pr-2" style="width: 15px;"></i> Beranda</a>
                                    ...
                                    <li class="nav-item">
                    <a class="nav-link" href="https://games.pediashop.my.id/wallet/"><i class="fa fa-coins" style="width: 15px;"></i> Saldo</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="https://games.pediashop.my.id/transaction/"><i class="fas fa-history" style="width: 15px;"></i> Riwayat</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="https://games.pediashop.my.id/blog/"><i class="fa fa-edit" style="width: 15px;"></i> Blog</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="https://games.pediashop.my.id/e_user/"><i class="fas fa-user" style="width: 15px;"></i> Profile</a>
                  </li>
                  <li class="nav-item">
